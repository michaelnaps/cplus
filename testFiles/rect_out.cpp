...
void Rectangle::display()
{
	...
	if (!fout.is_open()) { cout << "File did not open." << endl; }
	else {
		// output the dimensions in a linear fasion
		fout << endl;
		fout << "Rectangle: " << name << ", ";
		fout << "Location is (" << blPoint.getX() << ", " << blPoint.getY() << "), ";
		fout << "Length is " << length << ", ";
		fout << "Height is " << height << ", ";
		fout << "Area is " << area() << ", ";
		fout << "Perimeter is " << perimeter() << ", ";
		fout << "Midpoint is located at (" << midpoint.getX() << ", " << midpoint.getY() << ")" << endl;  // end with a newline
		...
		fout << "Area is " << area() << ", ";
		fout << "Perimeter is " << perimeter() << ", ";
		fout << "Midpoint is located at (" << midpoint.getX() << ", " << midpoint.getY() << ")" << endl << endl;  // end with a newline
	}
